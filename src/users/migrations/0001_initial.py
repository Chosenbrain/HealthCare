...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('subscribe', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('plan_id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique ID for every particular patient for every profile', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ManyToManyField(to='users.Status')),
